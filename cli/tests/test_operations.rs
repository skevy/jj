...
fn test_op_diff() {
    ...
    let output = work_dir.run_jj(["op", "log"]);
    insta::assert_snapshot!(output, @"
    @  5daaa23d2013 test-username@host.example.com default@ 2001-02-03 04:05:10.000 +07:00 - 2001-02-03 04:05:10.000 +07:00
    │  track remote bookmark bookmark-1@origin
    │  args: jj bookmark track bookmark-1
    ○  8303eb0ba22d test-username@host.example.com default@ 2001-02-03 04:05:09.000 +07:00 - 2001-02-03 04:05:09.000 +07:00
    ...
    insta::assert_snapshot!(output, @"
    From operation: 5daaa23d2013 (2001-02-03 08:05:10) track remote bookmark bookmark-1@origin
      To operation: 5daaa23d2013 (2001-02-03 08:05:10) track remote bookmark bookmark-1@origin
    [EOF]
    ");
    ...
    let output = work_dir.run_jj(["op", "diff", "--from", "@-", "--to", "@"]);
    insta::assert_snapshot!(output, @"
    From operation: 8303eb0ba22d (2001-02-03 08:05:09) fetch from git remote(s) origin
      To operation: 5daaa23d2013 (2001-02-03 08:05:10) track remote bookmark bookmark-1@origin
    ...
    let output = work_dir.run_jj(["op", "log"]);
    insta::assert_snapshot!(output, @"
    @    6e64554339ce test-username@host.example.com default@ 2001-02-03 04:05:21.000 +07:00 - 2001-02-03 04:05:21.000 +07:00
    ├─╮  reconcile divergent operations
    │ │  args: jj log
    ○ │  c22751764c9d test-username@host.example.com default@ 2001-02-03 04:05:19.000 +07:00 - 2001-02-03 04:05:19.000 +07:00
    ...
    │ ○  d3f6652e5b50 test-username@host.example.com default@ 2001-02-03 04:05:20.000 +07:00 - 2001-02-03 04:05:20.000 +07:00
    ...
    insta::assert_snapshot!(output, @"
    From operation: c22751764c9d (2001-02-03 08:05:19) point bookmark bookmark-1 to commit e8849ae12c709f2321908879bc724fdb2ab8a781
      To operation: 6e64554339ce (2001-02-03 08:05:21) reconcile divergent operations
    ...
    insta::assert_snapshot!(output, @"
    From operation: d3f6652e5b50 (2001-02-03 08:05:20) point bookmark bookmark-1 to commit 4ff6253913375c6ebdddd8423c11df3b3f17e331
      To operation: 6e64554339ce (2001-02-03 08:05:21) reconcile divergent operations
    ...
    insta::assert_snapshot!(output, @"
    From operation: 6e64554339ce (2001-02-03 08:05:21) reconcile divergent operations
      To operation: d4a1c8c42c59 (2001-02-03 08:05:25) fetch from git remote(s) origin
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: d4a1c8c42c59 (2001-02-03 08:05:25) fetch from git remote(s) origin
      To operation: 5ed441a6c171 (2001-02-03 08:05:27) create bookmark bookmark-2 pointing to commit e1a239a57eb15cefc5910198befbbbe2b43c47af
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 5ed441a6c171 (2001-02-03 08:05:27) create bookmark bookmark-2 pointing to commit e1a239a57eb15cefc5910198befbbbe2b43c47af
      To operation: 540c077d8725 (2001-02-03 08:05:29) track remote bookmark bookmark-2@origin
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 540c077d8725 (2001-02-03 08:05:29) track remote bookmark bookmark-2@origin
      To operation: ad23407db3f1 (2001-02-03 08:05:33) new empty commit
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: ad23407db3f1 (2001-02-03 08:05:33) new empty commit
      To operation: 246f122ff3f3 (2001-02-03 08:05:35) point bookmark bookmark-1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 246f122ff3f3 (2001-02-03 08:05:35) point bookmark bookmark-1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
      To operation: a18f893c5d0e (2001-02-03 08:05:37) delete bookmark bookmark-2
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: a18f893c5d0e (2001-02-03 08:05:37) delete bookmark bookmark-2
      To operation: 85130f50818e (2001-02-03 08:05:39) push all tracked bookmarks/tags to git remote origin
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 85130f50818e (2001-02-03 08:05:39) push all tracked bookmarks/tags to git remote origin
      To operation: 8c259bc5b0fb (2001-02-03 08:05:41) set tag tag1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 8c259bc5b0fb (2001-02-03 08:05:41) set tag tag1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
      To operation: f92ee2b34b24 (2001-02-03 08:05:45) delete tag tag1
...
fn test_op_show() {
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    01d8d34163ec test-username@host.example.com default@ 2001-02-03 04:05:17.000 +07:00 - 2001-02-03 04:05:17.000 +07:00
    reconcile divergent operations
    args: jj log
    [EOF]
    ");
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    66b3a88562b2 test-username@host.example.com default@ 2001-02-03 04:05:19.000 +07:00 - 2001-02-03 04:05:19.000 +07:00
    fetch from git remote(s) origin
    args: jj git fetch
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    2095956feb8b test-username@host.example.com default@ 2001-02-03 04:05:21.000 +07:00 - 2001-02-03 04:05:21.000 +07:00
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    3ef0799a395d test-username@host.example.com default@ 2001-02-03 04:05:23.000 +07:00 - 2001-02-03 04:05:23.000 +07:00
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    8d1bd8199933 test-username@host.example.com default@ 2001-02-03 04:05:27.000 +07:00 - 2001-02-03 04:05:27.000 +07:00
    new empty commit
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    445202b59b91 test-username@host.example.com default@ 2001-02-03 04:05:29.000 +07:00 - 2001-02-03 04:05:29.000 +07:00
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    2bbc9e3da07a test-username@host.example.com default@ 2001-02-03 04:05:31.000 +07:00 - 2001-02-03 04:05:31.000 +07:00
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    2e5e1cb21e38 test-username@host.example.com default@ 2001-02-03 04:05:33.000 +07:00 - 2001-02-03 04:05:33.000 +07:00
